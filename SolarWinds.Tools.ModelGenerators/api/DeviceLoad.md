...
```csharp
public class DeviceLoad : SolarWinds.Tools.ModelGenerators.InternetGenerator.DeviceComponent<SolarWinds.Tools.ModelGenerators.Metrics.UtilizationMetricData>
```
