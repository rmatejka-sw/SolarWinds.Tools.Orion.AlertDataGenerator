...
namespace SolarWinds.Tools.ModelGenerators.InternetGenerator
{
    ...
    public class InternetNetworkGenerator
    {
        ...
        public InternetNetworkGenerator(IInternetGeneratorOptions options)
        {
            ...
            this.maxConnectionsBetweenNodes = options.MaxConnectionsBetweenNodes > 0 ? options.MaxConnectionsBetweenNodes : 1;
            this.minInternalNodes = maxInternalNodes / 4;
            this.totalHops = options.MaxHops > 0 ? options.MaxHops : 15;
        ...
        public void CreateNetworks()
        {
            ...
            this.Devices.Clear();
            this.autonomousSystemNodeLayers.Clear();
