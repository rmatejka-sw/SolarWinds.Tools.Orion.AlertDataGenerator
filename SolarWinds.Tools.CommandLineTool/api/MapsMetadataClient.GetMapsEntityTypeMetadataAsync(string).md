...
## MapsMetadataClient.GetMapsEntityTypeMetadataAsync(string) Method

```csharp
public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.MapsClient.EntityType>> GetMapsEntityTypeMetadataAsync(string entityTypeCdl);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.MapsClient.MapsMetadataClient.GetMapsEntityTypeMetadataAsync(string).entityTypeCdl'></a>
