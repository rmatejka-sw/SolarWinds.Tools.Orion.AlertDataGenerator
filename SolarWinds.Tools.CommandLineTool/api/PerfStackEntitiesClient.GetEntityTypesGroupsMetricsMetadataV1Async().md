...
## PerfStackEntitiesClient.GetEntityTypesGroupsMetricsMetadataV1Async() Method

```csharp
public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.EntityType>> GetEntityTypesGroupsMetricsMetadataV1Async();
```
