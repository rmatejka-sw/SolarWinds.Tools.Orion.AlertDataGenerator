...
## MapsMetadataClient.GetMapsTypesMetadataAsync(CancellationToken) Method

```csharp
public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.MapsClient.EntityType>> GetMapsTypesMetadataAsync(System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.MapsClient.MapsMetadataClient.GetMapsTypesMetadataAsync(System.Threading.CancellationToken).cancellationToken'></a>
