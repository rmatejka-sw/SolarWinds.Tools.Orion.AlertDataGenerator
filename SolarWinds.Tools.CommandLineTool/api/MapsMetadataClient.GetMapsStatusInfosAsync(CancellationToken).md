...
## MapsMetadataClient.GetMapsStatusInfosAsync(CancellationToken) Method

```csharp
public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.MapsClient.StatusInfo>> GetMapsStatusInfosAsync(System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.MapsClient.MapsMetadataClient.GetMapsStatusInfosAsync(System.Threading.CancellationToken).cancellationToken'></a>
