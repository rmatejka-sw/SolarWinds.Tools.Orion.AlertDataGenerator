...
## MapsMetadataClient.GetMapsNetObjectMetadataAsync(string, CancellationToken) Method

```csharp
public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.MapsClient.NetObjectInfo>> GetMapsNetObjectMetadataAsync(string netobjectIds, System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.MapsClient.MapsMetadataClient.GetMapsNetObjectMetadataAsync(string,System.Threading.CancellationToken).netobjectIds'></a>

`netobjectIds` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

<a name='SolarWinds.Tools.CommandLineTool.Service.MapsClient.MapsMetadataClient.GetMapsNetObjectMetadataAsync(string,System.Threading.CancellationToken).cancellationToken'></a>
