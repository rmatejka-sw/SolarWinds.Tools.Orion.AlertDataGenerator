...
## MapsMetadataClient.GetMapsFilterPropertyConfigs2Async(CancellationToken) Method

```csharp
public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.MapsClient.DetailPropertyType>> GetMapsFilterPropertyConfigs2Async(System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.MapsClient.MapsMetadataClient.GetMapsFilterPropertyConfigs2Async(System.Threading.CancellationToken).cancellationToken'></a>
