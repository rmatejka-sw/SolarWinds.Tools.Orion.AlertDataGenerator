...
## PerfStackEntitiesClient.GetRelationshipsForEntityIdsAsync() Method

```csharp
public System.Threading.Tasks.Task<SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.EntitiesResponse> GetRelationshipsForEntityIdsAsync();
```
