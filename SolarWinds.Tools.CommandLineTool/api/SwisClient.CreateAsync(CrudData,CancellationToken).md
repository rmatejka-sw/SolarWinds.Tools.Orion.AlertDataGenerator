...
## SwisClient.CreateAsync(CrudData, CancellationToken) Method

```csharp
public System.Threading.Tasks.Task<string> CreateAsync(SolarWinds.Tools.CommandLineTool.Service.OrionSWISQueryClient.CrudData crudParameters, System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.OrionSWISQueryClient.SwisClient.CreateAsync(SolarWinds.Tools.CommandLineTool.Service.OrionSWISQueryClient.CrudData,System.Threading.CancellationToken).crudParameters'></a>
...
<a name='SolarWinds.Tools.CommandLineTool.Service.OrionSWISQueryClient.SwisClient.CreateAsync(SolarWinds.Tools.CommandLineTool.Service.OrionSWISQueryClient.CrudData,System.Threading.CancellationToken).cancellationToken'></a>
