...
## MapsMetadataClient.GetMapsNetObjectsMetadataAsync(CancellationToken) Method

```csharp
public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.MapsClient.NetObjectInfo>> GetMapsNetObjectsMetadataAsync(System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.MapsClient.MapsMetadataClient.GetMapsNetObjectsMetadataAsync(System.Threading.CancellationToken).cancellationToken'></a>
