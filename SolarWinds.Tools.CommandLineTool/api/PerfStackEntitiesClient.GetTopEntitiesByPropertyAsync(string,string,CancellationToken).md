...
## PerfStackEntitiesClient.GetTopEntitiesByPropertyAsync(string, string, CancellationToken) Method

```csharp
public System.Threading.Tasks.Task<SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.EntitiesResponse> GetTopEntitiesByPropertyAsync(string entityType, string propertyName, System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackEntitiesClient.GetTopEntitiesByPropertyAsync(string,string,System.Threading.CancellationToken).entityType'></a>

`entityType` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackEntitiesClient.GetTopEntitiesByPropertyAsync(string,string,System.Threading.CancellationToken).propertyName'></a>

`propertyName` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackEntitiesClient.GetTopEntitiesByPropertyAsync(string,string,System.Threading.CancellationToken).cancellationToken'></a>
