...
## PerfStackMetadataClient.GetPerfStackSettingsAsync(CancellationToken) Method

```csharp
public System.Threading.Tasks.Task<SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackSettings> GetPerfStackSettingsAsync(System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackMetadataClient.GetPerfStackSettingsAsync(System.Threading.CancellationToken).cancellationToken'></a>
