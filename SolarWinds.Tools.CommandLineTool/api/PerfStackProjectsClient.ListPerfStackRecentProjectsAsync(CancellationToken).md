...
## PerfStackProjectsClient.ListPerfStackRecentProjectsAsync(CancellationToken) Method

```csharp
public System.Threading.Tasks.Task<SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.ProjectResponse> ListPerfStackRecentProjectsAsync(System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackProjectsClient.ListPerfStackRecentProjectsAsync(System.Threading.CancellationToken).cancellationToken'></a>
