...
## MapsAlertsClient.GetActiveAlertsForEntitiesAsync(CancellationToken) Method

```csharp
public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.MapsClient.ActiveAlert>> GetActiveAlertsForEntitiesAsync(System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.MapsClient.MapsAlertsClient.GetActiveAlertsForEntitiesAsync(System.Threading.CancellationToken).cancellationToken'></a>
