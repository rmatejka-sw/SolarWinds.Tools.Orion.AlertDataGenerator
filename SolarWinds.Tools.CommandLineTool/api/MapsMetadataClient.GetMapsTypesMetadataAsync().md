...
## MapsMetadataClient.GetMapsTypesMetadataAsync() Method

```csharp
public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.MapsClient.EntityType>> GetMapsTypesMetadataAsync();
```
