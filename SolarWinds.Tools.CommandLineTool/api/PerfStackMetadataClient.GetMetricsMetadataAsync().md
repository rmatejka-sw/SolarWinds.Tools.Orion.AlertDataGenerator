...
## PerfStackMetadataClient.GetMetricsMetadataAsync() Method

```csharp
public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.Metric>> GetMetricsMetadataAsync();
```
