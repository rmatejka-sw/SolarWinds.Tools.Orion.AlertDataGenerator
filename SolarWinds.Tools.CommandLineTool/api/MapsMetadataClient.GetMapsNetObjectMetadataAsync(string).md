...
## MapsMetadataClient.GetMapsNetObjectMetadataAsync(string) Method

```csharp
public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SolarWinds.Tools.CommandLineTool.Service.MapsClient.NetObjectInfo>> GetMapsNetObjectMetadataAsync(string netobjectIds);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.MapsClient.MapsMetadataClient.GetMapsNetObjectMetadataAsync(string).netobjectIds'></a>
