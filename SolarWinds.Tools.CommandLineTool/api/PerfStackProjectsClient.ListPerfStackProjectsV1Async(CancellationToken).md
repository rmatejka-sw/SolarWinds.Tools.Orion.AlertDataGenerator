...
## PerfStackProjectsClient.ListPerfStackProjectsV1Async(CancellationToken) Method

```csharp
public System.Threading.Tasks.Task<SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.ProjectResponse> ListPerfStackProjectsV1Async(System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackProjectsClient.ListPerfStackProjectsV1Async(System.Threading.CancellationToken).cancellationToken'></a>
