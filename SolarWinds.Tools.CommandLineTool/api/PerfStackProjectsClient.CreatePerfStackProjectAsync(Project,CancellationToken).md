...
## PerfStackProjectsClient.CreatePerfStackProjectAsync(Project, CancellationToken) Method

```csharp
public System.Threading.Tasks.Task<SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.Project> CreatePerfStackProjectAsync(SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.Project project, System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackProjectsClient.CreatePerfStackProjectAsync(SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.Project,System.Threading.CancellationToken).project'></a>
...
<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackProjectsClient.CreatePerfStackProjectAsync(SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.Project,System.Threading.CancellationToken).cancellationToken'></a>
