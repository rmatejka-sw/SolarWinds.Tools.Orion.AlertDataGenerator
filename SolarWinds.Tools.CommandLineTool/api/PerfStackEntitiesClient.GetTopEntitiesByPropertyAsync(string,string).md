...
## PerfStackEntitiesClient.GetTopEntitiesByPropertyAsync(string, string) Method

```csharp
public System.Threading.Tasks.Task<SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.EntitiesResponse> GetTopEntitiesByPropertyAsync(string entityType, string propertyName);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackEntitiesClient.GetTopEntitiesByPropertyAsync(string,string).entityType'></a>

`entityType` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackEntitiesClient.GetTopEntitiesByPropertyAsync(string,string).propertyName'></a>
