...
## PerfStackEntitiesClient.GetEntityInfoV1Async(string, CancellationToken) Method

```csharp
public System.Threading.Tasks.Task<SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.EntitiesResponse> GetEntityInfoV1Async(string entityIdsCdl, System.Threading.CancellationToken cancellationToken);
```
#### Parameters

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackEntitiesClient.GetEntityInfoV1Async(string,System.Threading.CancellationToken).entityIdsCdl'></a>

`entityIdsCdl` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

<a name='SolarWinds.Tools.CommandLineTool.Service.PerfStackClient.PerfStackEntitiesClient.GetEntityInfoV1Async(string,System.Threading.CancellationToken).cancellationToken'></a>
